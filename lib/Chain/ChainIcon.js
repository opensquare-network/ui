...
import { ReactComponent as Shiden } from "../imgs/icons/chain/shiden.svg";
import { ReactComponent as Altair } from "../imgs/icons/chain/altair.svg";
import { ReactComponent as Rococo } from "../imgs/icons/chain/rococo.svg";
...
import Zeitgeist from "../imgs/icons/chain/zeitgeist.png";
import Parallel from "../imgs/icons/chain/parallel.png";
import Basilisk from "../imgs/icons/chain/basilisk.png";
import Hydradx from "../imgs/icons/chain/hydradx.png";
import Stafi from "../imgs/icons/chain/stafi.png";
import Creditcoin from "../imgs/icons/chain/creditcoin.png";
...
function ChainIcon({ chainName, size = 24 }) {
  ...
  return <Tooltip content={capitalize(chainName || "")}>{Icon}</Tooltip>;
}
